...
const PREVIEW_MESSAGES = [
  { id: 1, content: "Hey! How its going on", isSent: false },
  { id: 2, content: "I am foind great What about u", isSent: true },
];
export const SettingPage = () => {
  const { theme, setTheme } = useThemestore();
  return (
    // <div className="container mx-auto px-4 pt-20 max-w-5xl  h-[calc(100vh-5rem)]">
          ...
          {themes.map((t) => (
            <button
              ...
              className={`group flex flex-col items-center gap-1.5 p-2 rounded-lg transition-colors cursor-pointer ${
                theme === t ? "bg-base-300" : "hover:bg-base-100/50"
              }`}
              onClick={() => setTheme(t)}
            >
